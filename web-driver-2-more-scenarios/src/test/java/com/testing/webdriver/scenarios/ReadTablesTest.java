			...
			for (int i = 1; i < page_number; i++) {
				...
				for (int row = 0; row < rows_count; row++) {
					...
					for (int column = 0; column < columns_count; column++) {
						...
						if(celtext.equals("N800")) {
							System.out.println(Columns_row.get(0).getTagName());
						}
